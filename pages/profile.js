  ...
  handleDeletePost = deletedPost => {
    ...
    deletePost(deletedPost._id)
      .then(postData => {
        ...
        const updatedPosts = [
          ...this.state.posts.slice(0, postIndex), //get everything before the users index
          ...this.state.posts.slice(postIndex + 1) //get everything after the users index
        ];
        this.setState({
          posts: updatedPosts,
          isDeletingPost: false
